...
class UserCF:
    ...
    def test(self):
        ...
        print('1----- user A\'s recommend:', self.recommend("A"))
        print('1------user B\'s recommend:', self.recommend("B"))
        print('1------user C\'s recommend:', self.recommend("C"))
        ...
        print('2--------用户相似矩阵=')
        self.print_dict(self.users_sim)
        print('2----- user A\'s recommend:', self.recommend("A"))
        print('2------user B\'s recommend:', self.recommend("B"))
        print('2------user C\'s recommend:', self.recommend("C"))
        ...
        print('3--------用户相似矩阵=')
        self.print_dict(self.users_sim)
        print('3----- user A\'s recommend:', self.recommend("A"))
        print('3------user B\'s recommend:', self.recommend("B"))
        print('3------user C\'s recommend:', self.recommend("C"))
