...
class ChurnPredWithGBDT:
    ...
    def train_model(self, a, b, c):
        ...
        gbdt = GradientBoostingClassifier(
            learning_rate=a, n_estimators=b, max_depth=c
        )
...
if __name__ == "__main__":
    ...
    ls = []
    for i in range(1):
        gbdt = pred.train_model(0.09, 20, 2)
        accuracy, auc = pred.evaluate(gbdt)
        ls.append((accuracy, auc, i))
